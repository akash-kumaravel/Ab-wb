...
const FooterAbout: React.FC = () => (
  <div className="space-y-6">
    <div className="text-4xl font-black"><a href="https://www.memoinfotech.com/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">Memo Infotech</a></div>
