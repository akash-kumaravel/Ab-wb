    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="bg-gradient-to-b from-blue-600/20 to-transparent py-20 px-4">
        <div className="max-w-[1400px] mx-auto">
          <h1 className="text-5xl font-bold text-white mb-4">About RJ TEXTILE MACHINARY</h1>
      ...
      <section className="max-w-[1400px] mx-auto px-4 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div>
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              RJ TEXTILE MACHINARY is a global leader in textile machinery manufacturing and distribution. 
        ...
        <div className="bg-blue-600/10 border border-blue-600/50 p-12 rounded-sm text-center">
          ...
          <p className="text-gray-400 mb-6">
            Contact our sales team to discover how RJ TEXTILE MACHINARY can transform your textile production
          </p>
