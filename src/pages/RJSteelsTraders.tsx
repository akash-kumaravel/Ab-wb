...
const RJSteelsTraders: React.FC = () => (
  <div className="min-h-screen bg-[#080a0b] text-white">
    ...
    <section className="border-y border-[#293033] bg-[#d61f27] text-white"><div className="mx-auto max-w-[1400px] px-4 py-24 lg:px-10 lg:py-28"><div className="mb-14 max-w-2xl"><p className="mb-4 text-xs font-bold uppercase tracking-[0.25em] text-white/70">Our approach</p><h2 className="text-4xl font-black sm:text-5xl">A clearer way to trade scrap.</h2></div><div className="grid gap-8 md:grid-cols-5">{steps.map(([number, title, description]) => <div key={number} className="border-t border-white/30 pt-5"><p className="text-sm font-black">{number}</p><h3 className="mt-8 text-xl font-black">{title}</h3><p className="mt-3 text-sm leading-relaxed text-white/75">{description}</p></div>)}</div></div></section>
